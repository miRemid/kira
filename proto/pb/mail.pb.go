...
func (x *SendMailRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SendMailRes) ProtoMessage() {}

func (x *SendMailRes) ProtoReflect() protoreflect.Message {
	mi := &file_proto_mail_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SendMailRes.ProtoReflect.Descriptor instead.
func (*SendMailRes) Descriptor() ([]byte, []int) {
	return file_proto_mail_proto_rawDescGZIP(), []int{1}
}

func (x *SendMailRes) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *SendMailRes) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
var file_proto_mail_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x51, 0x0a, 0x0b, 0x53,
	0x65, 0x6e, 0x64, 0x4d, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x71, 0x12, 0x0e, 0x0a, 0x02, 0x74, 0x6f,
	...
	0x0a, 0x0b, 0x53, 0x65, 0x6e, 0x64, 0x4d, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x12, 0x18, 0x0a,
	...
	,
}
...
var file_proto_mail_proto_goTypes = []interface{}{
	(*SendMailReq)(nil), // 0: kira.micro.service.mail.SendMailReq
	(*SendMailRes)(nil), // 1: kira.micro.service.mail.SendMailRes
}
var file_proto_mail_proto_depIdxs = []int32{
	0, // 0: kira.micro.service.mail.MailService.SendMail:input_type -> kira.micro.service.mail.SendMailReq
	1, // 1: kira.micro.service.mail.MailService.SendMail:output_type -> kira.micro.service.mail.SendMailRes
